...
--
-- Passing functions that do weird things like running their continuations
...
-- 'Managed' with 'Cauldron.allowSelfDeps' and 'Cauldron.allowDepCycles'. Follow
-- the recommendations for the 'managed' function.
--
